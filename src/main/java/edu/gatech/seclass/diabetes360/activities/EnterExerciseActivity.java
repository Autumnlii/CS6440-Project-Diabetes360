...
public class EnterExerciseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveAndCloseButton.setOnClickListener(view -> {
            if (addExercise()) {
                Intent intent = new Intent(EnterExerciseActivity.this, MainActivity.class);
        ...
        saveAndNewButton.setOnClickListener(view -> {
            if (addExercise()) {
                Toast.makeText(EnterExerciseActivity.this, "Exercise Entry saved successfully", Toast.LENGTH_SHORT).show();
    ...
    private boolean addExercise() {
        ...
        try {
            ...
            Toast.makeText(EnterExerciseActivity.this, "Please enter all required " +
...
//        BloodSugarEntry offer = new BloodSugarEntry(validatedMonth, validatedDay, validatedValue);
        ...
        // Open the database for reading and writing, making sure the tables exist first
        ...
        db.insert(DatabaseHelper.TABLE_NAME_EX, null, values);

        // Close the database when done
        db.close();
        databaseHelper.debug(DatabaseHelper.TABLE_NAME_EX);
        return true;
    }
}